...
import Tsukeyithan.Packet.Packet138ReloadPlayerList;
 ...
 * MODIF
 */
    public void handleAddSkillEffect(Packet136AddSkillEffect packet)
	  {
    	 this.unexpectedPacket(packet);
	  }

	  public void handleRemoveSkillEffect(Packet137RemoveSkillEffect packet)
	  {
		  this.unexpectedPacket(packet);
	  }
	  
	  public void handleReloadPlayerList(Packet138ReloadPlayerList packet)
	  {
		  this.unexpectedPacket(packet);
	  }
    /**
