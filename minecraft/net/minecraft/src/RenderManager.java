...
import Tsukeyithan.Player.Vuurkhen.*;
import Tsukeyithan.Player.Araoseth.*;
import Tsukeyithan.Player.Sismeroan.*;
...
public class RenderManager
{
    ...
    private RenderManager()
    {
        ...
        entityRenderMap.put(TKHEntityNeerianFemale.class, new TKHRenderNeerianFemale());
        entityRenderMap.put(TKHCMPEntityNeerianFemale.class, new TKHRenderNeerianFemale());
        entityRenderMap.put(TKHOMPEntityNeerianFemale.class, new TKHRenderNeerianFemale());
        entityRenderMap.put(TKHEntityNeerianMale.class, new TKHRenderNeerianMale());
        entityRenderMap.put(TKHCMPEntityNeerianMale.class, new TKHRenderNeerianMale());
        entityRenderMap.put(TKHOMPEntityNeerianMale.class, new TKHRenderNeerianMale());
        
        entityRenderMap.put(TKHEntityVuurkhenFemale.class, new TKHRenderVuurkhenFemale());
        entityRenderMap.put(TKHCMPEntityVuurkhenFemale.class, new TKHRenderVuurkhenFemale());
        entityRenderMap.put(TKHOMPEntityVuurkhenFemale.class, new TKHRenderVuurkhenFemale());
        entityRenderMap.put(TKHEntityVuurkhenMale.class, new TKHRenderVuurkhenMale());
        entityRenderMap.put(TKHCMPEntityVuurkhenMale.class, new TKHRenderVuurkhenMale());
        entityRenderMap.put(TKHOMPEntityVuurkhenMale.class, new TKHRenderVuurkhenMale());
        
        entityRenderMap.put(TKHEntityAraosethFemale.class, new TKHRenderAraosethFemale());
        entityRenderMap.put(TKHCMPEntityAraosethFemale.class, new TKHRenderAraosethFemale());
        entityRenderMap.put(TKHOMPEntityAraosethFemale.class, new TKHRenderAraosethFemale());
        entityRenderMap.put(TKHEntityAraosethMale.class, new TKHRenderAraosethMale());
        entityRenderMap.put(TKHCMPEntityAraosethMale.class, new TKHRenderAraosethMale());
        entityRenderMap.put(TKHOMPEntityAraosethMale.class, new TKHRenderAraosethMale());
        
        entityRenderMap.put(TKHEntitySismeroanFemale.class, new TKHRenderSismeroanFemale());
        entityRenderMap.put(TKHCMPEntitySismeroanFemale.class, new TKHRenderSismeroanFemale());
        entityRenderMap.put(TKHOMPEntitySismeroanFemale.class, new TKHRenderSismeroanFemale());
        entityRenderMap.put(TKHEntitySismeroanMale.class, new TKHRenderSismeroanMale());
        entityRenderMap.put(TKHCMPEntitySismeroanMale.class, new TKHRenderSismeroanMale());
        entityRenderMap.put(TKHOMPEntitySismeroanMale.class, new TKHRenderSismeroanMale());
